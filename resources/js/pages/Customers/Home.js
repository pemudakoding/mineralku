...
import {IMG_SERTIFIKASI} from '@/assets/images'
...
const Home = (props) => {
    return (
        <>
            ...
            <main className='section-wrapper bg-blue-default-50 py-20'>
                <section className="about-section md:w-6/12 w-10/12 mx-auto mb-20">
                ...
                <section className="reason-section md:w-6/12 w-10/12 mx-auto">
                    <div className="container">
                        <div className="reason-title mb-10">
                            <h3 className='font-medium fredoka-one text-black text-2xl text-center'>Kenapa Harus Mineralku?</h3>
                        </div>
